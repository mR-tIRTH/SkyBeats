    ...
    <body>
        ...
        <div class="task-manager">
            ...
            <div class="page-content">
                <div class="header">Sky Beats</div>
                <div class="content-categories">
                    <div class="label-wrapper" onclick="topSongs();">
                        <input class="nav-item" name="nav" type="radio" id="opt-1">
                        <label class="category" for="opt-1">Top Hits</label>
                    </div>
                    <div class="label-wrapper" onclick="dashboard();">
                        <input class="nav-item" name="nav" type="radio" id="opt-2" checked>
                        <label class="category" for="opt-2">All Songs</label>
                    </div>
                    <div class="label-wrapper" onclick="editorsChoice();">
                        <input class="nav-item" name="nav" type="radio" id="opt-3">
                        <label class="category" for="opt-3">Editors Choice</label>
                    </div>
                    <div class="label-wrapper" onclick="popular();">
                        <input class="nav-item" name="nav" type="radio" id="opt-4">
                        <label class="category" for="opt-4">Recommends</label>
                    </div>
                </div>
                <div class="tasks-wrapper" id = -2>
                    ...
                    <div class="task"  id="-1" onclick="window.location = 'Player.jsp?id=<%= songs.getString("id")%>'">
                        ...
                        <span class="tag progress">Play</span>
                    </div>
                    <%
                            i++;
                        }
        ...
        <script type="text/javascript">
            ...
            <%
                try {
                    ResultSet PlayList = null;
                    Statement s = con.createStatement();
                    PlayList = s.executeQuery("Select songTitle,songID from editorchoice");
                    while (PlayList.next()) {
            %> songsName.push('<%= PlayList.getString("songTitle")%>');<%
            ...
            %>
                for (var i = 0; i < songsName.length; i++) {
                    ...
                    document.getElementById("-2").innerHTML +=
                            '<div class="task" id="-1"><label for="item-2"><span class="label-text" id="0" onclick="window.location = ' + "'" + 'Player.jsp?id=' + songId[i] + "'" + '">' + songsName[i] + '</span></label><span class="tag progress">Play Now</span></div>';
                }
            }
            function dashboard() {
                var ele = document.getElementById('-2');
            ...
            %>
                for (var i = 0; i < songsName.length; i++) {
                    ...
                    document.getElementById("-2").innerHTML +=
                            '<div class="task" id="-1"><label for="item-2"><span class="label-text" id="0" onclick="window.location = ' + "'" + 'Player.jsp?id=' + songId[i] + "'" + '">' + songsName[i] + '</span></label><span class="tag progress" onclick="window.location = ' + "'" + 'addToDownloads.jsp?id=' + songId[i] + "'" + '">Play Now</span></div>';
                }
            }
            function topSongs() {
                var ele = document.getElementById('-2');
            ...
            %>
                for (var i = 0; i < songsName.length; i++) {
                    ...
                    document.getElementById("-2").innerHTML +=
                            '<div class="task" id="-1" onclick="window.location = ' + "'" + 'Player.jsp?id=' + songId[i] + "'" + '"><label for="item-2"><span class="label-text" id="0">' + songsName[i] + '</span></label><span class="tag progress">Play Now</span></div>';
                }
            }
        </script>
    </body>
...
insert into editorchoice value("9", "LONELINESS");
insert into editorchoice value("7","Keeping Me Alive");
insert into editorchoice value("8","No Regrets");
insert into editorchoice value("3","Whatever It Takes");
insert into editorchoice value("1","SYMPHONY");
insert into editorchoice value("2","Everything OR Nothing");
insert into editorchoice value("4","Legends Never Die");
insert into editorchoice value("9","LONELINESS");

select * from editorchoice
*/-->