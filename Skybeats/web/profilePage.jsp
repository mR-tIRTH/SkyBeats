    ...
    <body>
        ...
        <div class="task-manager">
            <div class="left-bar">
                ...
                <div class="left-content">
                    ...
                    <%
                     ...
                     ResultSet rs = mystatement.executeQuery("Select * from auth");
                     try{
                         if(rs.next()){
                              name=rs.getString("name");
                             email=rs.getString("email");
                             id="100"+rs.getString("id");
            ...
            <div class="page-content">
                ...
                <span class="label-text"><h2>Plan :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <%= status %> </h2></span>
                <span class="label-text"><h2>Status :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <%if(accstatus.equals("1")){out.print("Active");}else{out.print("Bloacked");} %> </h2></span>
